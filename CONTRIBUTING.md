# Contributing to hypercore-promise
...
Fork the project [on GitHub](https://github.com/geut/hypercore-promise) and check out your copy locally.

```bash
$ git clone git@github.com:username/hypercore-promise.git
$ cd hypercore-promise
$ npm install
$ git remote add upstream git://github.com/geut/hypercore-promise.git
```
